      ...
      <div className="bg-[#252423]">
        ...
        <div className="relative flex h-full w-full items-center justify-center gap-8 px-[200px]">
          ...
          <div className="flex flex-1 justify-center">
            <img className="mt-20" width={450} src={SectionImage} />
          </div>
          <img src={SquareIcon} className="absolute bottom-[-10%] left-[40%]" />
        </div>
        <div className="relative mt-[200px] flex min-h-screen w-full items-center justify-center gap-8 px-[80px]">
          <div className="min-h-[800px] w-[90%] rounded-[30px] bg-[#191919] px-[100px] py-[70px]">
            ...
            <p className="font-brand mt-5 text-[18px] leading-[28px] text-white">
              Protect your business with our comprehensive threat detection and
              response services. Our team of experts will monitor your systems
              24/7, identify potential threats, and respond swiftly to minimize
              any damage.
            </p>
            <div className="mt-10 flex w-full items-center justify-center">
              <div className="flex flex-1 items-center gap-5">
                ...
                <div className="flex flex-col">
                  <p className="font-brand text-[24px] text-white">Detection</p>
              ...
              <div className="flex flex-1 items-center gap-5">
                <div className="h-24 border-l-2 border-gray-500"></div>
                <div className="flex flex-col">
                  <p className="font-brand text-[24px] text-white">Response</p>
                  <p className="font-brand text-[18px] text-[#A1A1A1]">
            ...
            <p className="font-brand mt-10 text-[18px] leading-[28px] text-white">
              Waiting until your first cyber incident to get your house in order
              is one of the worst business decisions one can make. Proper
              technology and cybersecurity postures are now the hallmarks of a
              healthy organization. Alignment with modern security standards is
              now a requirement for all, even if your industry is unregulated.
              Proof of compliance now must be furnished to banks, insurance
              companies, investors, and often, even your clients. For CPAs,
              RIAs, CCIMs, and medical practices, failure to maintain proper
              security, data protection, and business continuity tools can
              result in severe financial penalties and/or the loss of your
          ...
          <div className="flex min-h-screen w-full items-center justify-center px-[120px]">
            ...
            <div className="flex flex-1 flex-col items-center justify-center">
              ...
              <p className="font-brand mt-5 text-[18px]">
                At Top Notch, we’re not just about fixing problems; we’re about
                preventing them. Cyberattacks are increasing at an alarming
                rate, and traditional defenses only catch a fraction of the
                threats. As work environments evolve, users become prime
                targets.
              </p>
